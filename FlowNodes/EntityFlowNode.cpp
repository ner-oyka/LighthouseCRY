...
{
	// Add required null entries at end of input and output structures
...
{
	// Default empty inputs and outputs
	...
	// Set the procedural inputs and outputs created by the user
	if (!m_inputs.empty())
	{
...
void CEntityFlowNode::OnEntityEvent(IEntity* pEntity, const SEntityEvent& event)
{
	...
	case ENTITY_EVENT_DONE:
	{
		...
		// the input will still be the original entityId and should not be zeroed, or the node will stop working after a reset (this only can happen on editor mode)
